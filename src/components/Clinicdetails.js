    ...
    >
      <form className={styles.form}>
        ...
        <select
          ...
          defaultChecked={details?.length && details[0].clinic_name}
          name="hospitalselectedname"
          onChange={(e) => saveDetails(e)}
          
          disabled={
            hospitalDetails.hospitalname && hospitalDetails.hospitalname
          }
          >
        ...
        <input  
          disabled={hospitalDetails.hospitalselectedname}
